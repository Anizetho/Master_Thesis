...
mask_string = decode_hex(mask_header_hex_1)[0] + decode_hex(mask_header_hex_2)[0]   # 02102030405060708090A0B0C0D0E0F10103112131415161718191A1B1C1D1E1F101
key_string = decode_hex(key_header_hex_1)[0] + decode_hex(key_header_hex_2)[0]      # 00000102030405060708090a0b0c0d0e0f01101112131415161718191a1b1c1d1e1f
pt_string_1 = decode_hex(pt_header_hex)[0]                                          # 0400112233445566778899aabbccddeeff
