...
pico.setSimpleTrigger(channel='ext',threshold_mV=40,direction='rising',delay_samples=600,timeout_ms=3000) #300
pico.setSamplingParameters(preTrigger_ns=0,postTrigger_ns=800,timebase=1) #1450
